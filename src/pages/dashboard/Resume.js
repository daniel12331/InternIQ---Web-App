...
const Resume = () => {
  ...
  const handleAddSkill = () =>{
    setInterestInfo([...interestInfo, { skill: ""}]);
}

const handleRemoveSkill = (index) => {
    const list = [...interestInfo];
    list.splice(index, 1);
    setInterestInfo(list);
};
    ...
    <Wrapper>
            ...
            {/* fullname */}
              ...
              />
                ...
                <p></p>
                <h3 className=''>Add some interests</h3>
                {interestInfo.map((interests, index) => (
                <div  key={index}>
                      ...
                      <p></p>
                    <div className='btn__group'>
                        {interestInfo.length - 1 === index && interestInfo.length < 4 && (
